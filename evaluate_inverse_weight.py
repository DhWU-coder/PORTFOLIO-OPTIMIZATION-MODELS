...
lstm_transformer_model = tf.keras.models.load_model('model/lstm_transformer/lstm_transformer68.h5')  # load model
...
lstm_portfolio = build_portfolio(lstm_predictions, test_codes, test_dates, test_sectors, data_test)
transformer_portfolio = build_portfolio(transformer_predictions, test_codes, test_dates, test_sectors, data_test)
lstm_transformer_portfolio = build_portfolio(lstm_transformer_predictions, test_codes, test_dates, test_sectors, data_test)
...
plot_cumulative_returns_(lstm_portfolio, transformer_portfolio, lstm_transformer_portfolio, benchmark_df, save_dir='test3_pic')
plot_drawdowns_(lstm_portfolio, transformer_portfolio, lstm_transformer_portfolio, save_dir='test3_pic')
plot_return_distribution_(lstm_portfolio, transformer_portfolio, lstm_transformer_portfolio, save_dir='test3_pic')
plot_monthly_heatmap(lstm_portfolio, "LSTM", save_dir='test3_pic')
plot_monthly_heatmap(transformer_portfolio, "Transformer", save_dir='test3_pic')
plot_monthly_heatmap(lstm_transformer_portfolio, "LSTM_Transformer", save_dir='test3_pic')
